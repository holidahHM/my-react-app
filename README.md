...
=======
>>>>>>> 50a1120362c762f46357998acebe463a5673c17e
...
## Quick start(Adding a new Vue and how to map it)

Whenever you are creating a new vue remember to include the path in the routes.js and also the SideBaritem.vue if its a page within the Modules.
For example:
// -This is added in the routes.js under the Dashboard Layout children.
    {
        path: '/Communication_Dashboard',
        name: 'Communication Dashboard',
        component: () => import(/* webpackChunkName: "demo" */ '../views/Sites/Communication_Dashboard.vue')
      },
//The above needs to represented in the DashboardLayout.vue found in the Views Folder under the Layout folder subdirectory. 
       <sidebar-item 
          :link="{
            name: 'Dashboard',
            path: '/Communication_Dashboard',
...
>>>>>>> 50a1120362c762f46357998acebe463a5673c17e
            |-- Sites
                |--Accounting_Dashboard.vue
                |--BD_Dashboard.vue
                |--Communication_Dashboard.vue
                |--CRM_Dashboard.vue
                |--DocumentCentre_Dashboard.vue
                |--E-Board_Dashboard.vue
                |--E-Learning_Dashboard.vue
                |--Elections_Dashboard.vue
                |--Governance_Dashboard.vue
                |--Insurance_Dashboard.vue
                |--MasterSetup_Dashboard.vue
                |--Onboarding_Dashboard.vue
                |--Servicing_Dashboard.vue
                |--Reports_Dashboard.vue
