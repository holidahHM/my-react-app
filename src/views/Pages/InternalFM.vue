  ...
  <div>
    ...
    <base-header class="pb-6 pb-8 pt-5 pt-md-8 bg-gradient-success">
      ...
      <b-row>
        ...
        <b-col xl="2" md="6">
          <stats-card title="FUNDS PERFORMANCE"
                      sub-title="OVERVIEW"
                      class="mb-4">

            <template slot="footer">
              <span class="text-success mr-2">Fund Manager</span>
              <!--<span class="text-nowrap">Users-role</span>-->
            </template>
          </stats-card>
        </b-col>
        <b-col xl="3" md="6">
          <stats-card title="BONDS"
        ...
        <b-col xl="3" md="6">
          <stats-card title="STOCK MARKETS"
                      type="gradient-green"
                      sub-title="924"
        ...
        <b-col xl="8" class="mb-5 mb-xl-0">
          <card type="default" header-classes="bg-transparent">
            <b-row align-v="center" slot="header">
              <b-col>
                <h6 class="text-light text-uppercase ls-1 mb-1">Overview of Funds Performance</h6>
                <h5 class="h3 text-white mb-0">FUNDS PERFORMANCE</h5>
              </b-col>
              <b-col>
