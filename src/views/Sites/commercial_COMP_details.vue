  ...
  <base-header class="pb-6 pb-8 pt-5 pt-md-8 bg-gradient-success">
    <card>
      ...
      <h1 class="d-flex justify-content-center mb-3">
        {{ payload_Data.option.amount }} KSH Duration: 1 Month Motor Commercial
        Comprehensive by {{ payload_Data.option.name }}
      </h1>
      <br />
      <div class="row">
        <div class="col-sm-6">
...
export default {
  ...
  created() {
    this.payload_Data.carData = this.$route.params.cardet.commercialComprehensive;
