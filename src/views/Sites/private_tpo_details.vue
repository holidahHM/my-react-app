  ...
  <base-header class="pb-6 pb-8 pt-5 pt-md-8 bg-gradient-success">
    <card>
      ...
      <h1 class="d-flex justify-content-center mb-3">
        {{ payload_Data.option.amount }} KSH Duration: 1 Month Motor Private TPO by
        {{ payload_Data.option.name }}
      </h1>
      <br />
      <div class="row">
        <div class="col-sm-6">
...
export default {
  ...
  created() {
    this.payload_Data.thirdParty = this.$route.params.cardet.thirdparty;
    this.payload_Data.car_type = this.$route.params.cardet.cartype;
    this.payload_Data.selection_type = this.$route.params.cardet.selection_type;
    this.payload_Data.option = this.$route.params.cardet.selected;
    this.payload_Data.code = this.$route.params.cardet.code;
  },
  methods: {
    async buynow() {
