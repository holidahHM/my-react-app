        ...
        ><b-col class="col-md-12">
          <div class="col-xl-12 alert alert-info">
               <b-dropdown
                        ...
                        >
                          <b-dropdown-item
                            ><router-link to='/DefaultManager_Dashboard copy'>
        ...
        <b-col xl="8" class="mb-5 mb-xl-0">
          <card type="default" header-classes="bg-transparent">
            <b-row align-v="center" slot="header">
              <b-col>
                <h6 class="text-light text-uppercase ls-1 mb-1">Overview of ICT Performance</h6>
                <h5 class="h3 text-white mb-0">ICT PERFORMANCE</h5>
              </b-col>
              <b-col>
